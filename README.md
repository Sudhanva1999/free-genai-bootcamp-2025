...
- Speech transcription using Google Speech-to-Text API
- Comprehensive AI analysis of speaking performance using Claude 3 Sonnet
- Detailed feedback on grammar, relevance, vocabulary, and fluency
- Grading system with numeric scores and letter grades
- Suggested practice phrases in both Marathi and English

The speaking practice workflow includes:
1. Choosing a topic to speak about
