...
# Page config
st.set_page_config(
    page_title="Marathi Listening Practice",
    page_icon="🎧",
    layout="wide"
)
...
def render_interactive_stage():
    ...
    # Topic selection - Updated for Marathi language learning
    topics = {
        "Dialogue Practice": ["Daily Conversation", "Shopping", "Restaurant", "Travel", "Family", "Education", "Health"],
        "Phrase Matching": ["Greetings", "Directions", "Public Announcements", "Cultural Expressions", "Festivals"]
    }
    ...
    if st.session_state.current_question:
        ...
        if practice_type == "Dialogue Practice" or st.session_state.current_practice_type == "Dialogue Practice":
...
def main():
    st.title("Marathi Listening Practice")
    st.markdown("""
    Welcome to Marathi Listening Practice! This application helps you improve your Marathi listening comprehension skills.
    Choose a practice type and topic, then generate questions to test your understanding.
    """)
